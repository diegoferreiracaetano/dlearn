            ...
            AppContainerComponent(
                ...
                components = listOf(
                    AppMovieDetailHeaderComponent(
                        ...
                        downloadActionUrl = "download/157336",
                        shareActionUrl = "share/157336",
                    ),
                    AppExpandableSectionComponent(
                        title = "Storyline",
                        text = "A team of explorers travel through a wormhole in space in an attempt to ensure " +
                            "humanity's survival. The crew of the Endurance must travel to three potential " +
                            "planets to find a new home for mankind.",
                    ),
                    CarouselComponent(
                        title = "Cast & Crew",
                        items = listOf(
