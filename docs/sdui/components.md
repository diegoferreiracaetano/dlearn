...
O ecossistema DLearn utiliza componentes atômicos e moleculares definidos no módulo `:shared` e renderizados nativamente via Jetpack Compose (Android/iOS) seguindo as regras do **Design System**.
...
O componente raiz para a maioria das telas. Ele orquestra as barras de sistema e o conteúdo principal.
