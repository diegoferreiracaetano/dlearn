...
class AppControllerTest {
    ...
    @Test
    fun `given an authenticated user when POST v1 app is called should return the screen from orchestrator`() = testApplication {
        ...
        every { appOrchestrator.execute(any(), any(), any()) } returns flowOf(expectedScreen)

        val response = client.post("/v1/app") {
