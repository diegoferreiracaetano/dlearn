...
class UserControllerTest {
    ...
    @Test
    fun `given an authenticated user when GET v1 users is called should return the list of users`() = testApplication {
        ...
        val expectedUsers = listOf(User(id = "1", name = "Test", email = "test@test.com"))
