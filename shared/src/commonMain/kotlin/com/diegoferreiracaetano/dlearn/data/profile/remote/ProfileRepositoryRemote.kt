...
class ProfileRepositoryRemote(private val httpClient: HttpClient) : ProfileRepository {
    override fun getProfile(language: String?): Flow<Screen> = flow {
        val response = httpClient.get("v1/profile") {
