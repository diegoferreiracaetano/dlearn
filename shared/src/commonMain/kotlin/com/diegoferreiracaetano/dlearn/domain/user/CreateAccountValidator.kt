...
object PasswordValidator : CreateAccountValidator {
    override fun isValid(value: String): Boolean = value.length >= 5
}

object NameValidator : CreateAccountValidator {
    override fun isValid(value: String): Boolean = value.length >= 3
}

fun CreateAccountStepType.getValidationError(value: String) =
    when (this) {
